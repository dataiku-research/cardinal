...
import cardinAL
version = parse(cardinAL.__version__).base_version
...
# [howto/manual]).
latex_documents = [('contents', 'user_guide.tex', 'cardinAL user guide',
                    'Dataiku', 'manual'), ]
...
# thumbnails for the front page of the cardinAL home page.
...
issues_github_path = 'dataiku/cardinAL'
...
linkcode_resolve = make_linkcode_resolve('cardinAL',
                                         'https://github.com/dataiku/'
                                         'cardinAL/blob/{revision}/'
...
#TODO
#cardinAL.set_config(print_changed_only=True)
