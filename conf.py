...
project = u'cardinal'
copyright = u'2019-%s, Dataiku' % date.today().year
...
version = cardinal.__version__
# The full version, including alpha/beta/rc tags.
release = cardinal.__version__ + '-git'
...
latex_documents = [
    ('index', 'cardinal.tex', u'cardinal Documentation',
     u'Dataiku', 'manual'),
]
...
man_pages = [
    ('index', 'cardinal', u'cardinal Documentation',
     ['cardinal'], 1)
]
...
texinfo_documents = [
    ('index', 'cardinal', u'cardinal Documentation',
     'Dataiku', 'cardinal', 'One line description of project.',
     'Miscellaneous'),
]
