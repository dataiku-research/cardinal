...
This file contains a modified version of scikit-learn's KMeans
...
# Modified by: Alexandre Abraham <alexandre.abraham@gmail.com>
#              Leo Dreyfus-Schmidt <leo.dreyfus-schimdt@dataiku.com>
...
def _k_init(X, n_clusters, x_squared_norms, random_state, n_local_trials=None,
    ...
    start_centers = 0
    if fixed_cluster_centers is None:
        ...
        centers[:fixed_cluster_centers.shape[0]] = fixed_cluster_centers
        start_centers = fixed_cluster_centers.shape[0]
...
class KMeans(TransformerMixin, ClusterMixin, BaseEstimator):
    ...
    def _init_centroids(self, X, x_squared_norms, init, random_state,
                        init_size=None, fixed_cluster_centers=None):
        ...
        if isinstance(init, str) and init == 'k-means++':
            centers = _k_init(X, self.n_clusters, random_state=random_state,
        ...
        if fixed_cluster_centers is not None and init != 'k-means++':
            centers = np.vstack([fixed_cluster_centers, centers])
...
class IncrementalMiniBatchKMeans(KMeans):
    """
    ...
    def fit(self, X, y=None, sample_weight=None, fixed_cluster_centers=None,
        ...
        for init_idx in range(self._n_init):
            ...
            weight_size = self.n_clusters
            weight_sums = np.zeros(weight_size, dtype=sample_weight.dtype)
