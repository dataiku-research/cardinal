...
# it to the themes/cardinAL/static folder.
...
#                 'cardinAL', 'plotting', 'data', 'js', 'jquery.min.js'),
#    os.path.join(os.path.dirname(__file__), 'themes', 'cardinAL', 'static',
#                 'jquery.js'))
...
# We also add the directory just above to enable local imports of cardinAL
...
project = u'cardinAL'
copyright = u'The cardinAL developers 2019-2020'
...
html_short_title = 'cardinAL'

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = 'logos/cardinal.png'
...
# [howto/manual]).
latex_documents = [
  ('index', 'cardinal.tex', 'NeuroImaging with scikit-learn',
   'Dataiku'
   + r"\\\relax ~\\\relax http://cardinAL.github.io", 'manual'),
    ]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "logos/cardinal.png"
