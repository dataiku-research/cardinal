.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_plot_digits_metrics.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_plot_digits_metrics.py:
...
.. rst-class:: sphx-glr-horizontal
    ...
    *
      ...
      .. image:: /auto_examples/images/sphx_glr_plot_digits_metrics_001.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_digits_metrics_002.png
            :class: sphx-glr-multi-img

    *

      .. image:: /auto_examples/images/sphx_glr_plot_digits_metrics_003.png
            :class: sphx-glr-multi-img
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 3 minutes  52.117 seconds)

**Estimated memory usage:**  43 MB


.. _sphx_glr_download_auto_examples_plot_digits_metrics.py:
...
.. only :: html
 ...
 .. container:: sphx-glr-footer
  ...
  .. container:: sphx-glr-download
     ...
     :download:`Download Python source code: plot_digits_metrics.py <plot_digits_metrics.py>`



  .. container:: sphx-glr-download

     :download:`Download Jupyter notebook: plot_digits_metrics.ipynb <plot_digits_metrics.ipynb>`
